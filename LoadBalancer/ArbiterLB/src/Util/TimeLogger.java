...
public class TimeLogger {
    ...
    private ArrayList<OperationQueue> ques = null;
    ...
    public TimeLogger(String path, ArrayList<OperationQueue> a){
        this(path);
        this.ques = a;
    ...
    public void start(){
        ...
        timer = new Timer();
        timer.schedule(new StatChecker(this), 0, 1000);
    }
